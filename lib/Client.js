...
var Client = /** @class */ (function (_super) {
    ...
    function Client() {
        ...
        _this.on("message", _this.filterListener);
        return _this;
    }
    /**
     ...
     * @private
     */
    Client.prototype.filterListener = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.filter(message)];
                    case 1:
                        if (!(_a.sent())) {
                            message
                                .delete()
                                .catch(console.error)
                                .then(function () {
                                _this.emit("messageFiltered", message);
                            });
                        }
                        else {
